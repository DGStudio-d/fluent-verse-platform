        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Join interactive live sessions with native speakers and expert teachers from around the world
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8">
            {filteredSessions.map((session) => (
              <Card key={session.id} className={`overflow-hidden hover:shadow-xl transition-all duration-300 group ${session.featured ? 'ring-2 ring-blue-200' : ''}`}>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Share your language expertise with our global community of learners.
          </p>
